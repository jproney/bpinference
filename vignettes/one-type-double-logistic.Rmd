...
Next, we'll define the structure of our model. As in the `one-type-bp-inference` vignette, this will require three main components.

* A matrix of possible birth events. This is the same as in `one-type-bpinference.Rmd`.
* A parents vector. Also the same as in `one-type-bpinference.Rmd`.
