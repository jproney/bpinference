...
simulation_data = bpsims(mod, simulation_params, z0, times, rep(500,6), c_mat)

dat = stan_data_from_simulation(simulation_data, mod, cluster = T)
...
stan_mod <- stan_model(file = "clusters3.stan")
